locals {
  ...
  other_account_private_subnet_cidrs = toset(["10.0.0.0/24", "10.0.1.0/24", "10.0.2.0/24"])
  route_table_x_cidrs = toset(flatten([
    [for route_table_id in local.privat_subnet_route_tables : [
      for cidr in other_account_private_subnet_cidrs : {
